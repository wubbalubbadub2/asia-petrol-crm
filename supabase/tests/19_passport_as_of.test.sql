...
DECLARE
  ...
  s         RECORD;
BEGIN
  -- Галочки «в цене» задаём явно: с 00170 обе подняты по умолчанию, а
  -- этот тест считает баланс без Суммы 1 и включает её ниже отдельным
  -- шагом. Опираться на умолчание колонки здесь нельзя.
