...
- **Ручная дата.** У приложения появился третий вариант отсчёта — `manual`: плановую дату ставит менеджер, одна на все отгрузки приложения. Порядок разрешения: ручная дата приложения → режим «прочее» на сделке (00125) → дата СНТ + срок. При ручной дате срок в днях не показывается: он ни на что не влияет.
