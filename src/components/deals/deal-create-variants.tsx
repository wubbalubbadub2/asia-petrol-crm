...
export const EMPTY_VARIANT: VariantDraft = {
  // Клиент 2026-08-01 попросил вернуть формульный тип по умолчанию:
  // с дефолтом «Фикс / Вручную» (введён 2026-07-01) пропадал тумблер
  // «Предварительная / Окончательная» и весь блок формульной цены
  // (котировка / скидка / цена предв.), т.к. они показываются только для
  // формульного тира. Возвращаем DEFAULT_FORMULA_MODE («Формула: На дату»,
  // как было до 01.07) — тумблер снова виден на каждой новой сделке.
  // Быстрый ручной ввод по-прежнему доступен переключением «Тип цены».
