...
export default function NewDealPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (draftDealId) {
      ...
      // Migration 00078 — types regenerated by user.
      // Cast — generated database.ts hasn't been refreshed for the newest
      // price_condition enum values yet (manual_formula from 00071,
      // manual_in_formula from 00078). Postgres accepts them; the strict
      // TS shape doesn't until npm run types:db is rerun.
      ...
      // Migration 00078 — types regenerated by user.
      // Same cast rationale — manual_formula / manual_in_formula not yet
      // in regenerated types.
